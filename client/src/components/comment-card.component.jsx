...
const CommentCard = ({ index, leftVal, commentData }) => {
	...
	let {
		commented_by: {
			personal_info: { username: commented_by_username, fullname, profile_img },
		},
		commentedAt,
		comment,
		_id,
	...
	const removeCommentsCards = (startingPoint, isDeleted = false) => {
		...
		if (commentData.childrenLevel == 0 && isDeleted) {
		...
		setBlog({
			...
			activity: {
				...
				total_parent_comments:
					total_parent_comments -
					(commentData.childrenLevel == 0 && isDeleted ? 1 : 0),
			},
		});
	};
